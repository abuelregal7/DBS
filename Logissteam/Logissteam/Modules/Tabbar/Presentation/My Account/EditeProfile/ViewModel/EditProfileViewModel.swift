...
protocol EditProfileViewModelProtocol {
    // Inputs
    func viewDidLoad()
    func didTapOnUpdateButton(iban_image: Data?)
...
class EditProfileViewModel: BaseViewModel, EditProfileViewModelProtocol {
    ...
    func didTapOnUpdateButton(iban_image: Data? = nil) {
        ...
        updateProfileRequest.iban_image = iban_image
        updateProfile(body: updateProfileRequest)
    }
    
    func getIbanImage() -> String {
        return profileData?.ibanImage ?? ""
    }
