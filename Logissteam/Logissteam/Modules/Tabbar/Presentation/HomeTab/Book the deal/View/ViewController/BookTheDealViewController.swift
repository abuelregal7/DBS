//
//  BookTheDealViewController.swift
//  Logissteam
//
...
class BookTheDealViewController: BaseViewControllerWithVM<CategoriesDetailsViewModel> {
    ...
    override func bind() {
        ...
        bookDealButton
            ...
            .sink { [weak self] _ in
                guard let self else { return }
                self.viewModel.input.didTapOnBuyORBookDealButton.send("reserved")
            }
            .store(in: &cancellables)
...
extension BookTheDealViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
