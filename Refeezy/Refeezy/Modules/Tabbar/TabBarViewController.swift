...
class TabBarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        vc1 = TabsVCBuilder.home.viewController
        vc2 = TabsVCBuilder.rooms.viewController
        vc3 = TabsVCBuilder.gifts.viewController
        vc4 = TabsVCBuilder.more.viewController
    ...
    func forSwitchControllers(type: TabBarButtons) {
        ...
        case .home:
            UIView.animate(withDuration: 0.45) { [weak self] in
                guard let self = self else { return }
                self.tab_1_Label.textColor        =  UIColor().colorWithHexString(hexString: "FFFFFF")
                self.tab_2_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_3_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_4_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                
                self.tab_1_Icon.image             =  UIImage(named: "selectedHome")
                self.tab_2_Icon.image             =  UIImage(named: "unSelectedRooms")
                self.tab_3_Icon.image             =  UIImage(named: "unSelectedGifts")
                self.tab_4_Icon.image             =  UIImage(named: "unSelectedMore")
            }
        case .rooms:
            UIView.animate(withDuration: 0.45) { [weak self] in
                guard let self = self else { return }
                self.tab_1_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_2_Label.textColor        =  UIColor().colorWithHexString(hexString: "FFFFFF")
                self.tab_3_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_4_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                
                self.tab_1_Icon.image             =  UIImage(named: "unSelectedHome")
                self.tab_2_Icon.image             =  UIImage(named: "selectedRooms")
                self.tab_3_Icon.image             =  UIImage(named: "unSelectedGifts")
                self.tab_4_Icon.image             =  UIImage(named: "unSelectedMore")
            }
        case .gifts:
            UIView.animate(withDuration: 0.45) { [weak self] in
                ...
                self.tab_1_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_2_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_3_Label.textColor        =  UIColor().colorWithHexString(hexString: "FFFFFF")
                self.tab_4_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                
                self.tab_1_Icon.image             =  UIImage(named: "unSelectedHome")
                self.tab_2_Icon.image             =  UIImage(named: "unSelectedRooms")
                self.tab_3_Icon.image             =  UIImage(named: "selectedGifts")
                self.tab_4_Icon.image             =  UIImage(named: "unSelectedMore")
            }
        ...
        case .more:
            UIView.animate(withDuration: 0.45) { [weak self] in
                ...
                self.tab_2_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_3_Label.textColor        =  UIColor().colorWithHexString(hexString: "676D75")
                self.tab_4_Label.textColor        =  UIColor().colorWithHexString(hexString: "FFFFFF")
    ...
    @IBAction func onClickTabBar(_ sender: UIButton) {
        ...
        case 1: forSwitchControllers(type: .rooms)
        case 2: forSwitchControllers(type: .gifts)
        case 3: forSwitchControllers(type: .more)
        default:
            break
        }
    }
