//
//  SecondRequestDetailsViewController.swift
//  Refeezy
//
...
class SecondRequestDetailsViewController: BaseViewControllerWithVM<SecondRequestDetailsViewModel> {
    ...
    override func bind() {
        ...
        viewModel.showOrdereDataPublisher
            ...
            .sink { [weak self] data in
                ...
                let dateString = data?.room?.expiredAt ?? ""
...
extension SecondRequestDetailsViewController: UITableViewDelegate, UITableViewDataSource {
