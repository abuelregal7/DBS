//
//  FirstRequestDetailsViewModel.swift
//  Refeezy
//
...
protocol FirstRequestDetailsViewModelProtocol {
    // Inputs
    var input: FirstRequestDetailsViewModel.Input { get }
    
    // Outputs
    var output: FirstRequestDetailsViewModel.Output { get }
...
class FirstRequestDetailsViewModel: BaseViewModel, FirstRequestDetailsViewModelProtocol {
