//
//  SwiftCollection_Extension.swift
//  Maintenance
//
...
private func makeCombinedChunks<Output, Failure: Swift.Error> (input: [AnyPublisher<[Output],Failure>]) -> [AnyPublisher<[Output], Failure>] {
    sequence( state: input.makeIterator(),
